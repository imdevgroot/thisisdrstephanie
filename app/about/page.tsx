    ...
    <>
      ...
      <main>
        ...
        <section className="min-h-[85vh] flex items-center relative overflow-hidden">
          ...
          <div className="hidden md:block absolute top-20 right-10 w-96 h-96 bg-primary/5 rounded-full blur-3xl pointer-events-none" />
          <div className="hidden md:block absolute bottom-10 left-10 w-64 h-64 bg-accent rounded-full blur-2xl pointer-events-none" />
          ...
          <div className="relative w-full mx-auto max-w-7xl px-6 lg:px-8 pt-28 pb-16 lg:pt-32 lg:pb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative max-w-sm mx-auto lg:max-w-none">
                ...
                <div className="hidden md:block absolute -bottom-6 -left-6 w-44 h-44 bg-primary/10 rounded-3xl z-0" />
                <div className="hidden md:block absolute -top-3 -right-3 w-20 h-20 border-2 border-primary/20 rounded-full z-0" />

                {/* Stats card — z-20 to sit above image z-10 */}
                <div className="absolute -bottom-4 -right-4 md:-bottom-5 md:-right-5 z-20 bg-primary text-primary-foreground p-4 md:p-5 rounded-2xl shadow-xl">
        ...
        <section className="py-20 lg:py-28 bg-card relative overflow-hidden">
          <div className="hidden md:block absolute top-0 left-0 font-serif text-[12rem] text-primary/[0.02] leading-none select-none pointer-events-none">
            Story
          </div>
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid lg:grid-cols-12 gap-16">
              <div className="lg:col-span-4">
                <span className="inline-block w-10 h-1 bg-primary rounded-full mb-5" />
                <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-foreground leading-tight lg:sticky lg:top-28">
                  My{" "}
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    ...
                    <div className={`ml-20 lg:ml-0 lg:w-1/2 ${index % 2 === 0 ? "lg:pr-16 lg:text-right" : "lg:pl-16"}`}>
                      <div className="bg-card p-5 rounded-2xl border border-border/50 hover:border-primary/30 transition-all hover:shadow-md">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {values.map((value) => (
                <div
                  key={value.title}
                  className="group bg-card rounded-2xl p-7 border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-md hover:-translate-y-1"
                >
        ...
        <section className="py-20 lg:py-28 relative overflow-hidden">
          ...
          <div className="hidden md:block absolute top-0 right-0 w-1/2 h-full bg-primary/20 blur-3xl pointer-events-none" />
          <div className="hidden md:block absolute bottom-0 left-0 w-32 h-32 border border-white/10 rounded-full pointer-events-none" />
